...
-(void)getInfoHolmes
{
    ...
    NSString*shortBio=@"Heather Holmes is a busy woman.  You might find her in a math classroom at Orono High School where she teaches Algebra IA, IIB and Intro to College math. She also coaches the math team at Orono and is a class advisor every year.  In addition she works as a unit secretary at a local hospital. “Ive always had a second job,” she says, “because I don’t like to sit around at home.” After earning a Bachelors degree at U Maine Farmington and a Masters at U Maine Orono, she taught at Hampden Academy and then Winslow High School before coming to Orono in 2003. When she isn’t working either at the high school or at the hospital, she loves to travel. “My favorite place is Death Valley,” she says. ";
...
-(void)getInfoLibby
{
    ...
    NSString*shortBio=@"Chris Libby’s favorite part of math is statistics. In addition to teaching statistics he teaches Albegra 1b and Geometry A. He is a U Maine Orono graduate and has been at Orono since he began teaching in 2001. When he isn’t teaching he enjoys all running sports and coaches the Orono track team. He is a golf enthusiast as well as a mountain biker. He also is in charge of the score board for the football games";
...
-(void)getInfoBoyd
{
    ...
    NSString*coursesTaught=@"(Anatomy, Biology, Forensic Science, Marine Science ) ";
...
-(void)getInfoCBoyd
{
    ...
    NSString*shortBio=@"Ms. Boyd began teaching at Orono High School in 1998.  She brought teaching experience from Central Aroostook High School, Presque Isle High School, Jackman, Penobscot Job Corps, and Beal College.  Being a true “County girl” at heart, she enjoys the small size of Orono High School, where students have the luxury of much one-on-one with their teachers.  Ms. Boyd is also the Crimson Crier Yearbook Adviser.  When not teaching,  Ms. Boyd enjoys nature and being with her family.";
